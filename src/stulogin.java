...
public class stulogin extends javax.swing.JFrame {
    ...
    public stulogin() {
        ...
        setTitle("College Library-Login Student Account");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        h.StuNo = jTextField2.getText();
     //   stuNo=jTextField2.getText();
        password = jPasswordField1.getText();
        //String studno=st.StuNo;
        ResultSet qw;
        //qw=st.check(studno,password);
        int qlid=0;
        String qpass="";
        if (h.StuNo.trim().length() < 1 && password.trim().length() < 1) {
            JOptionPane.showMessageDialog(null, "please fill the details!!!");
        } else if (h.StuNo.trim().length() < 1) {
            JOptionPane.showMessageDialog(null, "please enter student no!!!");
        } else if (password.trim().length() < 1) {
            JOptionPane.showMessageDialog(null, "please enter password!!!");
        } else
        {
            qw = h.check(h.StuNo, password);
            try {

                while (qw.next()) {
                    qlid = qw.getInt("stu_no");
                    qpass = qw.getString("password");

                }

                if (qlid ==Integer.parseInt(h.StuNo)  && qpass.equals(password)) {
                    stuwork s=new stuwork();
            s.show();
            ...
            //JOptionPane.showMessageDialog(null, stuNo);
            
            
          //  updatestudent up=new updatestudent();
          //  up.stu=stuNo;
          //  JOptionPane.showMessageDialog(null, up.stu);
            
            //issuebook i=new issuebook();
            //i.stun=st.StuNo;
            //JOptionPane.showMessageDialog(null, i.stun);
